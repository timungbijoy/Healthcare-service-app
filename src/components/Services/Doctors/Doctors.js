  ...
  const swalAlert = (event, message) => {
    ...
    return swal("Write the data here:", {
      ...
      const response = await axios.post(
        "https://ayush-2af81-default-rtdb.firebaseio.com/Doctors.json",
        { doctorname: message, appointment: value, username: user.displayName }
      );
                  ...
                  >
                    ...
                    >
                      ...
                      <CardActions sx={{ textAlign: "center" }}>
                        <Button
                          onClick={(event) => swalAlert(event, doctor.name)}
                          sx={{ mt: 2, mb: 1 }}
                          variant="contained"
